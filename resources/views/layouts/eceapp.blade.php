...
<style>
    #hero-img {
        background-image: url("{{ asset('eceimages/bg-img-two.jpg') }}");
    }
</style>
<body>
<header class="bg-[#4359CF]">
    <!-- Navbar -->
    <nav
        class="flex items-center justify-between py-4 max-w-[1450px] mx-auto"
    >
        ...
        <ul class="hidden lg:flex items-center gap-10">
            <li>
                <div class="group relative cursor-pointer py-2">
                    <div class="flex items-center justify-between space-x-5 px-4">
                        <a
                            class="menu-hover my-2 py-2 text-base font-normal text-white capitalize"
                            onClick=""
                        >
                            About
                        </a>
                  ...
                  >
                    ...
                    >
                        ...
                        <a
                            class="my-2 block border-b border-gray-100 py-1 font-semibold text-gray-500 white-space-nowrap hover:text-black md:mx-2"
                        >
                            ECE department
                        </a>
                    </div>
            ...
            <li>
                <div class="group relative cursor-pointer py-2">
                  ...
                  >
                    ...
                    >
                        <a
                            class="my-2 block border-b border-gray-100 py-1 font-semibold text-gray-500 hover:text-black md:mx-2 testece" id="detail-syllabus-link"
                        >
                            Test
                        </a>

                        <a
                            href="./fee-structure.html"
                            class="my-2 block border-b border-gray-100 py-1 font-semibold text-gray-500 white-space-nowrap hover:text-black md:mx-2"
                        >
                            Fee Structure
                        </a>
            ...
            <li class="text-base font-normal text-white capitalize">
                <a href="/gallery"> Gallery </a>
            </li>
            <li class="text-base font-normal text-white capitalize">
                <a href="./faculty-profilet.html">Faculty Profile</a>
            </li>
            <li class="text-base font-normal text-white capitalize">
