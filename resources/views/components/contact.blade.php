...
<body>--}}
<section class="py-24 max-w-[1450px] mx-auto">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 grid-cols-1">
                        ...
                        <div class="absolute bottom-0 w-full lg:p-11 p-5">
                            <div class="bg-white rounded-lg p-6 block">
                                <a href="javascript:;" class="flex items-center mb-6">
                                    ...
                                    <h5
                                        class="text-black text-base font-normal leading-6 ml-5"
                                    >
                                        470-601-1911
                                    </h5>
                                </a>
            ...
            <div class="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                <h2
                    class="text-indigo-600 font-manrope text-4xl font-semibold leading-10 mb-11"
                >
                    Send Us A Message
                </h2>
                @if(session('success'))
                ...
                <div class="mb-10">
                    ...
                    <div class="flex">
                        <div class="flex items-center mr-11">
                            ...
                            >
                    <span
                        class="border border-gray-300 rounded-full mr-2 w-4 h-4 ml-2"
                    ></span>
                                Email
                            </label>
                        </div>
